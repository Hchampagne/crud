            ...
            <div class="row">
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <p class="span">&nbsp<?= isset($messError['photo']) ? $messError['photo'] : ""; ?></p>
                    </div>
                    <div>
                        <img src="<?= "../assets/images/" . $produit->pro_id . "." . $produit->pro_photo ?>" class="img-responsive" height="250" width="250">
                    </div>
                </div>
                <div class="col-md-7">
                    <div class="form-group">
